...
export const LandingPage = () => {
  ...
  return (
    <LandingPageLayout>
      <main className="rounded border-2 border-slate-300 p-4 space-y-4 shadow-sm shadow-slate-300">
        <section>
          <h1 className="text-3xl font-medium">Rekomendasi Pemanfaatan ZRA</h1>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            <div>
              ...
              <Select name="radionuclide">
                ...
                <SelectContent>
                  ...
                  <SelectItem value="system">Am-241</SelectItem>
                </SelectContent>
              </Select>
            </div>

            <div>
              <Label htmlFor="initialActivity">Initial Activity</Label>
              <Input
                type="text"
                id="initialActivity"
            ...
            <div>
              <div className="mb-4">
                ...
                <p className="text-sm">Current Value : {years} yr</p>
              </div>
              <Slider
                name="year"
                defaultValue={[years]}
        ...
        <section>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
            <div className="p-2 border border-slate-300 rounded order-last lg:order-first">
              {!isLoading ? (
                <Table>
                  <TableCaption>Data that inputted to model</TableCaption>
                  <TableHeader>
                    <TableRow>
                      <TableHead>ZRA Number</TableHead>
                      <TableHead>Radionuclide</TableHead>
                      <TableHead>Metadata</TableHead>
                      <TableHead>Previous Usage</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                    <TableRow>
            ...
            <div className="p-4 border border-slate-300 rounded h-[400px] overflow-y-scroll">
              <div>
                {isLoading ? (
                  <Skeleton className="h-[200px]" />
                ) : (
                  <div>
                    ...
                    <div className="space-y-2">{recommendations}</div>
                  </div>
                )}
              </div>
            </div>
